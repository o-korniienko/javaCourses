...
public class TestJscrollpane {
    ...
    private static  String TEXT = "You can get a blog started in less time than \n"
    ...
    public static void createGUI() {
        ...
        JCheckBox checkBox1 = new JCheckBox("Show vertical scrollbar");
        ...
        JCheckBox checkBox2 = new JCheckBox("Show horizontal scrollbar");
